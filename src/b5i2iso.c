...
if (argc < 2)
    ...
    exit(EXIT_FAILURE);
            ...
            if (argc >= (3+cue)) strcpy(destfilename, argv[2+cue]);
                       ...
                       if (strlen(argv[1+cue]) < 5 || strcmp(destfilename+strlen(argv[1+cue])-4, ".B5I")
